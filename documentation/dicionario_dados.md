...
erDiagram
    ...
    dim_satisfaction ||--o{ fact_attrition : "1 : N (EnvironmentSatisfaction; JobInvolvement; JobSatisfaction; WorkLifeBalance)"
    ...
    dim_satisfaction ||--o{ fact_survey : "1 : N (EnvironmentSatisfaction; JobInvolvement; JobSatisfaction; WorkLifeBalance)"
